...
export default function Card({name,channel="vivek"}){ // default value is vivek...
    console.log(channel)
  return (
        ...
        <div className="p-4">
          ...
          <div className="mt-3 flex items-center space-x-2">
            <img
              ...
              src="https://images.pexels.com/photos/19955808/pexels-photo-19955808.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Dan_Abromov"
            />
